controllerProvider.register('PurchaseOrderController', ['$scope', 'PurchaseOrderApi', '$rootScope', '$timeout', '$uibModal', '$filter', 'fileReader', 'toastr', PurchaseOrderController]);


function PurchaseOrderController($scope, PurchaseOrderApi, $rootScope, $timeout, $uibModal, $filter, fileReader, toastr) {
    debugger;
    //$scope.ShowTableData = true;
    //$scope.ShowFrmAddUpdate = false;
    //$rootScope.ViewLoading = true; 

    ////PurchaseOrderApi.GetCitiesByCountryId(7).then(function (response) {
    ////    debugger;
    ////    $rootScope.ViewLoading = true;
    ...
    ////PurchaseOrderApi.GetAllShipmentTypes().then(function (response) {
    ////    debugger;
    ////    $rootScope.ViewLoading = true;
    ...
    ////PurchaseOrderApi.GetAllProductSizes().then(function (response) {
    ////    $rootScope.ViewLoading = true;
    ...
    //    }
    //    PurchaseOrderApi.Save($scope.Courier).then(function (response) {
    //        debugger;
    ...
    //    $rootScope.ViewLoading = true;
    //    PurchaseOrderApi.SaveCourierDetails(CourierDetail).then(function (response) {
    //        debugger;
    //        switch (response.data.OperationStatus) {
    ...
    //    debugger;
    //    if (CourierDetail.DetailID == null) {
    ...
    //    }
    //    else {
    //        var index = $scope.Courier.CourierDetails.indexOf($filter('filter')($scope.Courier.CourierDetails, { 'DetailID': CourierDetail.DetailID }, true)[0]);
